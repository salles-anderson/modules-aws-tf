...
variable "ec2_instance_ids" {
  description = "Lista de IDs de instâncias EC2 para gerenciar. Se vazio, usa tags para descoberta."
  type        = list(string)
  default     = []
}

variable "resource_tag_key" {
  description = "Chave da tag para descoberta automática de instâncias EC2."
  type        = string
  default     = null
}

variable "resource_tag_value" {
  description = "Valor da tag para descoberta automática de instâncias EC2."
  type        = string
  default     = null
}
