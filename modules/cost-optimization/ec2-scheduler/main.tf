locals {
  ...
  lambda_function_name = coalesce(var.lambda_function_name, "${var.project_name}-ec2-scheduler")
...
resource "aws_lambda_function" "this" {
  ...
  description      = "Lambda para stop/start agendado de instâncias EC2"
...
resource "aws_scheduler_schedule" "stop" {
  ...
  description = "Para instâncias EC2 fora do horário comercial"
...
resource "aws_scheduler_schedule" "start" {
  ...
  description = "Inicia instâncias EC2 no início do horário comercial"
  state       = var.enable_schedule ? "ENABLED" : "DISABLED"
